    ...
    private ArrayList<String> generateSharedPrefs(String requestCode){
        ...
        if (requestCode.indexOf("MC") == -1){
            ...
            if (requestCode.equals("Addition")){
                ...
                levelData.add("Multiplication" + "/" + "Hard" + "/" + Integer.toString(0)  + "/" + Integer.toString(COLOR_UNATTEMPTED) + "/" + "MultiplicationHardDescription" + "/" + Integer.toString(0) + "/" + Integer.toString(0) + "/" + "Multiplication" + "/" + "Hard" + "/" + "0");
                ...
                levelData.add("Division" + "/" + "Hard" + "/" + Integer.toString(0)  + "/" + Integer.toString(COLOR_UNATTEMPTED) + "/" + "DivisionHardDescription" + "/" + Integer.toString(0) + "/" + Integer.toString(0) + "/" + "Division" + "/" + "Hard" + "/" + "0");
                ...
                levelData.add("Perimeter" + "/" + "Hard" + "/" + Integer.toString(0)  + "/" + Integer.toString(COLOR_UNATTEMPTED) + "/" + "PerimeterHardDescription" + "/" + Integer.toString(0) + "/" + Integer.toString(0) + "/" + "Perimeter" + "/" + "Hard" + "/" + "0");
                ...
                levelData.add("Area" + "/" + "Hard" + "/" + Integer.toString(0)  + "/" + Integer.toString(COLOR_UNATTEMPTED) + "/" + "AreaHardDescription" + "/" + Integer.toString(0) + "/" + Integer.toString(0) + "/" + "Area" + "/" + "Hard" + "/" + "0");
                ...
                levelData.add("Algebra" + "/" + "Hard" + "/" + Integer.toString(0) + "/" + Integer.toString(COLOR_UNATTEMPTED) + "/" + "AlgebraHardDescription" + "/" + Integer.toString(0) + "/" + Integer.toString(0) + "/" + "Algebra" + "/" + "Hard" + "/" + "0");
            }
        }
        //"{Level Type}/{Level Difficulty}/{Level Completions}/{Button Color}/{Level Description Tag}/{Progress(Times completed out of 10)}/{Locked (0 or 1)}/{Intent Type}/{Intent Difficulty}/{Intent Mode}"
        else {
            ...
            if (requestCode.equals("MCStandardAddition")) {
                ...
                levelData.add("MCStandardAddition" + "/" + "Hard" + "/" + Integer.toString(0) + "/" + Integer.toString(COLOR_UNATTEMPTED) + "/" + "MCStandardAdditionHardDescription" +  "/" + Integer.toString(0) + "/" + Integer.toString(0) + "/" + "0" + "/" + "2" + "/" + "0");
                ...
                levelData.add("MCTimerAddition" + "/" + "Hard" + "/" + Integer.toString(0) + "/" + Integer.toString(COLOR_UNATTEMPTED) + "/" + "MCTimerAdditionHardDescription" +  "/" + Integer.toString(0) + "/" + Integer.toString(0) + "/" + "0" + "/" + "2" + "/" + "2");
                ...
                levelData.add("MCStreakAddition" + "/" + "Hard" + "/" + Integer.toString(0) + "/" + Integer.toString(COLOR_UNATTEMPTED) + "/" + "MCStreakAdditionHardDescription" +  "/" + Integer.toString(0) + "/" + Integer.toString(0) + "/" + "0" + "/" + "2" + "/" + "1");
                ...
                levelData.add("MCStandardSubtraction" + "/" + "Hard" + "/" + Integer.toString(0) + "/" + Integer.toString(COLOR_UNATTEMPTED) + "/" + "MCStandardSubtractionHardDescription" +  "/" + Integer.toString(0) + "/" + Integer.toString(0) + "/" + "1" + "/" + "2" + "/" + "0");
                ...
                levelData.add("MCTimerSubtraction" + "/" + "Hard" + "/" + Integer.toString(0) + "/" + Integer.toString(COLOR_UNATTEMPTED) + "/" + "MCTimerSubtractionHardDescription" +  "/" + Integer.toString(0) + "/" + Integer.toString(0) + "/" + "1" + "/" + "2" + "/" + "2");
                ...
                levelData.add("MCStreakSubtraction" + "/" + "Hard" + "/" + Integer.toString(0) + "/" + Integer.toString(COLOR_UNATTEMPTED) + "/" + "MCStreakSubtractionHardDescription" +  "/" + Integer.toString(0) + "/" + Integer.toString(0) + "/" + "1" + "/" + "2" + "/" + "1");
                ...
                levelData.add("MCStandardMultiplication" + "/" + "Hard" + "/" + Integer.toString(0) + "/" + Integer.toString(COLOR_UNATTEMPTED) + "/" + "MCStandardMultiplicationHardDescription" +  "/" + Integer.toString(0) + "/" + Integer.toString(0) + "/" + "2" + "/" + "2" + "/" + "0");
                ...
                levelData.add("MCTimerMultiplication" + "/" + "Hard" + "/" + Integer.toString(0) + "/" + Integer.toString(COLOR_UNATTEMPTED) + "/" + "MCTimerMultiplicationHardDescription" +  "/" + Integer.toString(0) + "/" + Integer.toString(0) + "/" + "2" + "/" + "2" + "/" + "2");
                ...
                levelData.add("MCStreakMultiplication" + "/" + "Hard" + "/" + Integer.toString(0) + "/" + Integer.toString(COLOR_UNATTEMPTED) + "/" + "MCStreakMultiplicationHardDescription" +  "/" + Integer.toString(0) + "/" + Integer.toString(0) + "/" + "2" + "/" + "2" + "/" + "1");
                ...
                levelData.add("MCStandardDivision" + "/" + "Hard" + "/" + Integer.toString(0) + "/" + Integer.toString(COLOR_UNATTEMPTED) + "/" + "MCStandardDivisionHardDescription" +  "/" + Integer.toString(0) + "/" + Integer.toString(0) + "/" + "3" + "/" + "2" + "/" + "0");
                ...
                levelData.add("MCTimerDivision" + "/" + "Hard" + "/" + Integer.toString(0) + "/" + Integer.toString(COLOR_UNATTEMPTED) + "/" + "MCTimerDivisionHardDescription" +  "/" + Integer.toString(0) + "/" + Integer.toString(0) + "/" + "3" + "/" + "2" + "/" + "2");
                ...
                levelData.add("MCStreakDivision" + "/" + "Hard" + "/" + Integer.toString(0) + "/" + Integer.toString(COLOR_UNATTEMPTED) + "/" + "MCStreakDivisionHardDescription" +  "/" + Integer.toString(0) + "/" + Integer.toString(0) + "/" + "3" + "/" + "2" + "/" + "1");
            }
        }
